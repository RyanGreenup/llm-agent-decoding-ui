...
export default function About() {
  ...
  return (
    <main>
      <Hero
        title="About"
        subtitle="A simple interface for comparing and exploring large language models."
      />
      <div class="mx-auto max-w-4xl px-4 py-8 space-y-6">
        <Card title="What is LLM Agent?">
          <p>
            LLM Agent provides a clean overview of available large language
            models, their pricing, and context window sizes — helping you pick
